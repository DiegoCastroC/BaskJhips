    ...
    .config(function ($stateProvider) {
        $stateProvider
            .state('partido', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'basjhipsterApp.partido.home.title'
                },
                views: {
                    'content@': {
            ...
            .state('partido.detail', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'basjhipsterApp.partido.detail.title'
                },
                views: {
                    'content@': {
            ...
            .state('partido.new', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function($stateParams, $state, $modal) {
                    $modal.open({
                        ...
                        resolve: {
                            entity: function () {
                                return {fecha: null, puntosLocal: null, puntosVisitante: null, id: null};
                            }
                        }
