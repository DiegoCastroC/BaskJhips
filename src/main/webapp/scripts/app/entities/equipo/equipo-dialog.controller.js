...
angular.module('basjhipsterApp').controller('EquipoDialogController',
    ['$scope', '$stateParams', '$modalInstance', '$q', 'entity', 'Equipo', 'Estadio', 'Socio', 'Entrenador', 'Jugador', 'Partido', 'Temporada',
        function($scope, $stateParams, $modalInstance, $q, entity, Equipo, Estadio, Socio, Entrenador, Jugador, Partido, Temporada) {
        ...
        var onSaveFinished = function (result) {
            $scope.$emit('basjhipsterApp:equipoUpdate', result);
