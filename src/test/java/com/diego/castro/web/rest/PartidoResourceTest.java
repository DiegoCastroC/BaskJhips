...
import com.diego.castro.repository.PartidoRepository;
...
public class PartidoResourceTest {
    ...
    private static final Integer DEFAULT_PUNTOS_LOCAL = 1;
    private static final Integer UPDATED_PUNTOS_LOCAL = 2;

    private static final Integer DEFAULT_PUNTOS_VISITANTE = 1;
    private static final Integer UPDATED_PUNTOS_VISITANTE = 2;
